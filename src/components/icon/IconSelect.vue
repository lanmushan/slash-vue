...
<style>
  ...
  .icon_lists.dib-box::-webkit-scrollbar {
    width: 0px;
  }
  ...
  .icon_lists.dib-box .dib .name {
    display: none;;
  }

  .icon_lists.dib-box .dib .iconfont {

    font-size: 26px;
  }

  .icon_lists.dib-box .dib:hover {
    background: rgba(193, 195, 196, 0.18);
  }

  .icon_lists.dib-box .dib .iconfont:hover {
    font-size: 30px;
  }
</style>
